...
using TRex.Metadata;
using WebAppForCustomLogicAppConnector.Helpers;
using WebAppForCustomLogicAppConnector.Models;

namespace WebAppForCustomLogicAppConnector.Controllers
{
    public class BooksController : ApiController
    {
        private readonly BooksSingleton _books = BooksSingleton.Instance;
        private static readonly CallbacksSingleton _callbacks = CallbacksSingleton.Instance;
        ...
        [SwaggerResponse(HttpStatusCode.OK, "An array of subscriptions", typeof(Array))]
