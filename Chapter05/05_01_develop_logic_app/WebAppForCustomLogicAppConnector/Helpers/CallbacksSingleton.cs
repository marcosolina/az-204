...
using System.Linq;
using System.Web;
using WebAppForCustomLogicAppConnector.Models;

namespace WebAppForCustomLogicAppConnector.Helpers
{
    public class CallbacksSingleton
    {
        ...
        public void AddCallback(Callback callback)
        {
            ...
            {
                //avoid duplicates
                Callback callbackToBeAdded = _callbacks.FirstOrDefault(c => Uri.Compare(
                        c.Uri,
                        callback.Uri,
        ...
        {
            Callback callbackToModify = _callbacks.SingleOrDefault(b => b.Id.Equals(callback.Id));
        ...
        public bool DeleteCallbackById(string id)
        {
            ...
            Callback callbackToRemove = _callbacks.SingleOrDefault(b => b.Id.Equals(guidToRemove));
