...
RESOURCE_GROUP=AZ204-Marco-Logic-App-rg
RESOURCE_GROUP_LOCATION="UK South"
DEPLOYMENT_NAME=AZ204-Marco-Dep
ARM_TEMPLATE=arm-logic-app.json
OVERRIDE_PROPS=arm-logic-app-param.json

# Props to override
APP_NAME=marco-logic-app
...
then  
	...
	sed -i 's/APP_NAME/'"$APP_NAME"'/' $NEW_OVERRIDE_PROPS
